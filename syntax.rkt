...
;; [(wave 10 0.5 0) (0.4 0.3 0.5) 0.1]
;; [(wave 10 0.5 0) (0.55 0 0) -0.2]
;; [(wave 10 0.6 20) (0 0.5 0) 0.01]
;; [(wave 40 0.2 0) (0 0 0.4) 1]

;; (send/mood ("raspberrypi.local" 1234 18 150)
;;            [(dim 100) (255 147 41) 1])
...
;; (send-quote "raspberrypi.local" 1234 'stop)
